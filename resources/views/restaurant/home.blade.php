    ...
    <div class="card mb-5">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-8">
                    ...
                    <div class="row mt-2">
                        <div class="input-icons col-1 pr-0">
                            <span class="text-info fa fa-map-marker align-middle" aria-hidden="true" style="font-size: 20px;"></span>
                        </div>
                        <div class="col-10 float-left pl-0">
                            <select class="form-control col-5" name="branch_id" id="restaurant-branches" required autofocus>
                ...
                <div class="col-3">
                    <button type="button" class="btn btn-info btn-md float-right" onclick="window.location='/restaurant/add-branch'">+ Branch
                    </button>
                </div>
            </div>
        </div>
